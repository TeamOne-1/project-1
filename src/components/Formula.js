        ...
        return (
            <div className={style.template}>
                <div className={style.table}>
                    <div className={style.table}>
                    <div className={style.title}>Project Scope Fields

                        <div style={{ padding: "20px 0 0 0" }}>
                        <div>
                        <label>name</label>
                        <input type="checkbox" disabled="disabled" onClick={(event) => this.onClickCheckbox(event)} checked />
          </div>
                        <div>
                            <label>cost_code</label>
                            <input type="checkbox" onClick={(event) => this.onClickCheckbox(event)} />
                            </div>
